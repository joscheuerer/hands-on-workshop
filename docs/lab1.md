...
On the left side of the screen click on **Deploy** icon, then click onw **Workflow Groups**. In there **Create Workflow Group** with **Resource Name** = ``wfg-xx`` (xx is your assigned number)
